...
var specLeafClass = map[string]leafClass{
	...
	"spec.LLM.Providers[].Arm":                                               mints,
	"spec.LLM.Providers[].Model":                                             mints,
	"spec.LLM.Providers[].AzureOpenAI.Endpoint":                              mints,
	"spec.LLM.Providers[].AzureOpenAI.DeploymentName":                        mints,
	"spec.LLM.Providers[].AzureOpenAI.APIVersion":                            mints,
	"spec.LLM.Providers[].VertexAI.ProjectID":                                mints,
	"spec.LLM.Providers[].VertexAI.Region":                                   mints,
	"spec.LLM.Providers[].Bedrock.Region":                                    mints,
	"spec.LLM.Providers[].Bedrock.Guardrail":                                 mints,
	"spec.LLM.Providers[].Custom.Host":                                       mints,
	"spec.LLM.Providers[].Custom.Port":                                       mints,
	"spec.LLM.Providers[].Custom.PathPrefix":                                 mints,
	"spec.LLM.EgressAllowlist[].Arm":                                         mints,
	"spec.LLM.EgressAllowlist[].Models[]":                                    mints,
	"spec.LLM.EgressAllowlist[].AzureOpenAI.Endpoint":                        mints,
	"spec.LLM.EgressAllowlist[].AzureOpenAI.DeploymentName":                  mints,
	"spec.LLM.EgressAllowlist[].AzureOpenAI.APIVersion":                      mints,
	"spec.LLM.EgressAllowlist[].VertexAI.ProjectID":                          mints,
	"spec.LLM.EgressAllowlist[].VertexAI.Region":                             mints,
	"spec.LLM.EgressAllowlist[].Bedrock.Region":                              mints,
	"spec.LLM.EgressAllowlist[].Bedrock.Guardrail":                           mints,
	"spec.LLM.EgressAllowlist[].Custom.Host":                                 mints,
	"spec.LLM.EgressAllowlist[].Custom.Port":                                 mints,
	"spec.LLM.EgressAllowlist[].Custom.PathPrefix":                           mints,
	"spec.LLM.Fallback.Arm":                                                  mints,
	"spec.LLM.Fallback.Model":                                                mints,
	"spec.LLM.Fallback.AzureOpenAI.Endpoint":                                 mints,
	"spec.LLM.Fallback.AzureOpenAI.DeploymentName":                           mints,
	"spec.LLM.Fallback.AzureOpenAI.APIVersion":                               mints,
	"spec.LLM.Fallback.VertexAI.ProjectID":                                   mints,
	"spec.LLM.Fallback.VertexAI.Region":                                      mints,
	"spec.LLM.Fallback.Bedrock.Region":                                       mints,
	"spec.LLM.Fallback.Bedrock.Guardrail":                                    mints,
	"spec.LLM.Fallback.Custom.Host":                                          mints,
	"spec.LLM.Fallback.Custom.Port":                                          mints,
	"spec.LLM.Fallback.Custom.PathPrefix":                                    mints, // A16, and r7 BLOCKER 2
