...
// (2026-09-14), design 03 amendments A84 and A85 (both 2026-09-23) and design
// 03 amendment A86 (2026-09-24). AGENTS.md tells every
...
// value below does not change, because 03 was already approved in part), and 16's first slice (ADR-0024 Amendment 1, 2026-09-14). Every
...
func TestNoDesignClaimsAnApprovalTheHumanDidNotGive(t *testing.T) {
	...
	if len(wrong) > 0 {
		t.Errorf("%d claims of approval differ from what the human decided. The only approvals the human has "+
			"given are design 03's first slice, A84, A85 and A86, and design 16's first slice. Correct the document. "+
