...
| 3 | Policy compiler (CR → agentgateway config, incl. expose) | P1 | M | **approved** (`03-…`, ADR-0020, review PASS); amendments A1–A7 (2026-08-26) — two REVISE rounds addressed, pending a third pass |
