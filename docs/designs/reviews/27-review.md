...
| 5 | MINOR | **Resolved.** D2 now states it checkably: an OSS user can enable chaining and run `assayd compliance verify` standalone — "tamper-evident receipts require no license" — with enterprise adding the bundle, enforcement, reports, and support. ADR-0015 demonstrated rather than asserted. |
