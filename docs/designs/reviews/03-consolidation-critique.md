...
**Files most relevant to acting on this critique**: `docs/designs/03-policy-compiler.md`, `docs/designs/reviews/03-consolidation-inventory.md`, `api/v1alpha1/agent_types.go`, `charts/assayd/values.yaml`, `cmd/operator/main.go`, `config/rbac/role.yaml`, `docs/designs/16-evalsuite.md`, `docs/designs/02-agent-crd.md`, `docs/research/mcp-session-statefulness-2026-09.md`, `Makefile`, `test/conformance/`.
