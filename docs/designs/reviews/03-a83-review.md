...
- **Date**: 2026-09-23.
- **Reviewer**: an independent adversarial pass, following `.claude/skills/review-code` and `.claude/skills/critique-design`. Two rounds, against two heads.
- **Target**: PR #55 (`a83-policy-half-message`), base `main` `80b63b5`; and amendment A83, which that PR adds and which had never been critiqued. `docs/designs/README.md` says in terms that A82 and A83 have not been critiqued — this round is that critique, so this file is its output and not a precondition of it.
...
## Round 1 — the three MAJORs, all fixed in the round
...
## Round 2 — the two MAJORs, both fixed in the round
...
## Two the reviewer explicitly cleared
