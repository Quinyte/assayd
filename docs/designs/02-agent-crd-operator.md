...
- **Status**: **integrated r3** — amendments A1–A15 folded into the body (A15, 2026-08-25, revised after critique returned REVISE; awaiting re-critique. A16 is owed and not drafted: see design 03 A6 on leaf-level classification) (the independent re-critique asked for one integration pass rather than a rule telling implementers which half to believe). Amendment history is preserved in §12 for provenance only; **the body is authoritative**. · ADR-0019
