...
- **Status**: **not approved by the human** — critique PASS at r2 (reviews/04-review.md) · ADR-0021 · **A5 (2026-09-04) uncritiqued** — what the exporter actually emits for A4's witness fields, measured (`research/agentgateway-otlp-attributes-2026-09.md`); `hop.route` added; `ns` attribution and the Azure `deploymentName` limit are the real gaps · **Corrected 2026-09-23 by the human's decision**: until then this line opened "approved". The human has not approved any part of this design; a critique PASS is evidence about the prose, not an approval. The only human approvals on record are design 03's first slice and its amendment A84, and design 16's first slice.
