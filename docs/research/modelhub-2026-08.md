...
- **KServe RawDeployment mode**: runs without Knative/Istio — the reason binding KServe respects doctrine rule 5 (≤8 pods) and ADR-0012's meshless core. Serverless mode is forbidden in assayd; chart pins raw. https://kserve.github.io/website/latest/modelserving/servingruntimes/
